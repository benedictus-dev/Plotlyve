defmodule PlotlyveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PlotlyveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PlotlyveWeb.Gettext, "errors", msg, opts)
    end
  end
